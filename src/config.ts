...
export const DOWNMIX_CEILING_DBFS = -3.0;
export const DOWNMIX_LIMIT_ALLOWANCE_DB = 6.0;
export const DOWNMIX_GAIN_MIN_DB = -12.0;
export const DOWNMIX_GAIN_MAX_DB = 12.0;
export const DOWNMIX_LIMITER_LIMIT = 0.708;
...
export const VIDEO_INPUT_PARAMS = ['-hwaccel', 'auto'];
export const HDR_REFERENCE_WHITE = 203;
export const HLG_NOMINAL_PEAK = 1000;
export const HDR_FALLBACK_PEAK = 1000;
...
export const CANCELED_JOBS_FILE = 'canceled-jobs.json';